    ...
    public partial class frmModuleAdd : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (paramModuleID.Length > 0)
            {
                ...
                Result = myBLLModelInfo.UpdateModuleInfo(paramID,paramModuleName, paramParamFormName, paramParentID);
            }
            else
            {

                Result = myBLLModelInfo.AddModuleInfo(paramModuleName, paramParamFormName, paramParentID);
            }
            if (Result > 0)
            {
